...
const AppProvaider = ({children}) => {
    ...
    return (
        <Context.Provider value={{jugador1, setJugador1, jugador2, setJugador2, datosIngresados, setDatosIngresados, simbolJug1, setSimbolJug1, simbolJug2, setSimbolJug2, posiciones, fichaJug1, setFichaJug1, hayGanador, setHayGanador, letraGanadora, setLetraGanadora, turnoJug1, setTurnoJug1, hayEmpate, setHayEmpate}}>
            {children}
        </Context.Provider>
